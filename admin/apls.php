                        ...
                        <table class="table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <button class="btn btn-success btn-xs" onclick="ac(0)">Accept</button>
                                        <button class="btn btn-danger btn-xs" onclick="ac(1)">Reject</button>
...
<script>
    ...
    function ac(val) {
        ...
        if (confirm('Are you sure to '+text) == true) {
            $('#show').load("submit_aply.php?val=" + val).fadeIn('fast');
