                        ...
                        <form class="form-bordered" action="all_submit_page.php" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="degid" name="degid" class="form-control" value="<?php echo $row2[0]['degid']; ?>" style="width:100%" placeholder="Enter Degree Name" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>
                                        <b>
                                    ...
                                    <input type="text" id="crsnm" name="crsnm" class="form-control" value="<?php echo $row2[0]['crsnm']; ?>" style="width:100%" placeholder="Enter Degree Name" required>
                                </div>
